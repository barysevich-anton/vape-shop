        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edytować zamówienie</li>
                </ol>
            </div>


            <h4>Edytować zamówienie #<?php echo $id; ?></h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Status</p>
                        <select name="status">
                            <option value="1" <?php if ($order['status'] == 1) echo ' selected="selected"'; ?>>Nowe zamówienie</option>
                            <option value="2" <?php if ($order['status'] == 2) echo ' selected="selected"'; ?>>W przetwórstwie</option>
                            <option value="3" <?php if ($order['status'] == 3) echo ' selected="selected"'; ?>>W trakcie dostawy</option>
                            <option value="4" <?php if ($order['status'] == 4) echo ' selected="selected"'; ?>>Zamknięte</option>
                        </select>
                        <br>
                        <br>
